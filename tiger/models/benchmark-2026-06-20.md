...
> **Pass 2 update ([[benchmark-2026-06-20-constrained]], 2026-06-20):** the constrained-tool Haiku test ran. Result corrects the line above — **only [[keyword-clusters]] is Flash/Haiku-safe** (pure set-regrouping). The three *numeric* constrained tools ([[analysis]], [[cohort-diagnosis]], [[lead-source-diagnosis]]) **degrade on Haiku** (inverted economics / fabricated counts / text corruption) and need ≥ Sonnet too. The real split is **categorical vs numeric**, not constrained vs creative.
