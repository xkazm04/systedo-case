---
name: Tomáš (PPC specialist)
role: PPC / paid-media specialist (agency account manager) running the brand's Google Ads
maps_to: Campaign Intelligence, AI Marketing Tools (ads), Performance Dashboard
tech_level: power-user
promotion: discovery
references:
  - https://agencyanalytics.com/blog/ppc-kpis — ROAS, CPA, CTR, conversion rate, the daily KPI set
  - https://www.designrush.com/agency/paid-media-pay-per-click/trends/ppc-tracking — Impression-Share-Lost(Budget), message-market fit signals
---
...
- The portfolio is triaged for him: rule-breachers (paused-but-spending, ROAS/PNO far below target, low CTR with high impression share) are flagged with a **reason**, and he can sort worst-first.
- A flag he can trust: the severity maps to a real rule he'd recognize, and the AI evaluation references the actual numbers — not generic advice.
- AI ad output respects Google Ads / Sklik character limits and shows an Ad Strength signal he can defend.

## Pet peeves / friction triggers
- A flat table he has to eyeball — no priority, no "why flagged".
