...
const EXPECTED_ORDER = {
  eshop: ["", "vykon", "start", "kampane", "klicova-slova", "sklad-sezonnost", "obsahovy-engine", "kreativa", "produktova-kreativa", "kanaly", "socialni", "twin", "sprava-kanalu", "schranka", "knihovna", "reporty", "zisk", "ltv", "katalog", "ucet", "branding", "spotreba", "mesicni-report", "aktivita", "integrace", "nastaveni"],
  app: ["", "vykon", "start", "kampane", "klicova-slova", "srovnani-seo", "obsahovy-engine", "experimenty-lp", "kanaly", "socialni", "twin", "sprava-kanalu", "schranka", "knihovna", "reporty", "ltv", "katalog", "ucet", "branding", "spotreba", "mesicni-report", "aktivita", "integrace", "nastaveni"],
  leadgen: ["", "vykon", "start", "kampane", "klicova-slova", "lokalni", "obsahovy-engine", "kanaly", "twin", "sprava-kanalu", "schranka", "knihovna", "reporty", "kvalita-leadu", "katalog", "ucet", "branding", "spotreba", "mesicni-report", "aktivita", "integrace", "nastaveni"],
  content: ["", "vykon", "start", "klicova-slova", "obsahovy-engine", "kreativa", "kanaly", "socialni", "twin", "sprava-kanalu", "schranka", "distribuce", "reporty", "publikum", "katalog", "ucet", "branding", "spotreba", "mesicni-report", "aktivita", "integrace", "nastaveni"],
  local: ["", "vykon", "start", "kampane", "klicova-slova", "lokalni", "mapa", "obsahovy-engine", "recenze", "obsah-plan", "kanaly", "socialni", "twin", "sprava-kanalu", "schranka", "reporty", "katalog", "ucet", "branding", "spotreba", "mesicni-report", "aktivita", "integrace", "nastaveni"],
};
