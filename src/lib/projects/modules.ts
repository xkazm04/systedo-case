...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    blurbEn: "AI content brief and published articles with structure and internal linking.",
  },
  {
    key: "socialni",
    label: "Sociální sítě",
  ...
  },
  {
    ...
    blurbEn: "Topic clusters (pillar + supporting) and refresh of decaying content.",
  },
  {
    key: "distribuce",
    label: "Distribuce",
