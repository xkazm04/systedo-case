...
const MIGRATIONS: Migration[] = [
  {
    version: 1,
    name: "base schema (46 tables + projects/cron_runs/twin_archive/campaign_docs indexes)",
...
export function getDb(): DatabaseSync {
  ...
  if (!db) {
    ...
    // current 46-table schema declares none, so this is forward-looking hygiene; it
