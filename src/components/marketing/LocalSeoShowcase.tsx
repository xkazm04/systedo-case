...
const CONTENT = {
  cs: {
    ...
    sub: "Pozice v mapovém balíčku, recenze a Google Business Profile napříč pobočkami — v jednom pracovním prostoru. Stiskněte tlačítko a sledujte, jak pin stoupá z #4 na #1.",
    ...
    compSub: "Pozice #1 bere lví podíl prokliků v balíčku.",
