...
const CONTENT = {
  cs: {
    ...
    sub: "Pozice v mapách, recenze a Google Business Profile napříč pobočkami. V jednom pracovním prostoru. Stiskněte tlačítko a sledujte, jak pin stoupá z #4 na #1.",
    ...
    chartsSub: "Ilustrativní data: stejná vizualizace, jakou moduly vykreslují nad reálným katalogem klienta.",
    rankTitle: "Výstup v mapě za 90 dní",
    rankSub: "Váš pin #4 → #1, zatímco nejsilnější rival ztrácí.",
    visTitle: "Viditelnost v mapách",
    visSub: "Jak často se pobočka objeví v mapách pro sledovaná hledání.",
    visCaption: "viditelnost",
    compTitle: "Podíl na proklicích",
    compSub: "Pozice #1 bere lví podíl prokliků v mapách.",
    ...
    rank: {
      ...
      visibility: "Viditelnost v mapách",
      target: "cíl",
  ...
  en: {
    ...
    rankSub: "Your pin #4 → #1 while the top rival drifts.",
    ...
    compSub: "Rank #1 takes the lion's share of clicks in the map pack.",
