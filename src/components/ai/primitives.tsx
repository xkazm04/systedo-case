...
const T = {
  cs: {
    ...
    autoRepaired: "Automaticky opraveno",
  ...
  en: {
    copyDefault: "Copy",
    copied: "Copied",
    charOverLimit: "Over the character limit",
    charInLimit: "Within the limit",
    demoMode: "Demo mode (no API key)",
    generatedBy: "Generated by the model · {s}",
    inputTokens: "input",
    outputTokens: "output",
    tokensUnit: "tokens",
    tokensTok: "tok",
    subscriptionFree: "The dev provider runs on a subscription (Claude Code): no per-token charge",
    ...
    autoRepairedTitleDefault: "The output was automatically corrected to platform limits",
    copyAll: "Copy all",
    showPrompt: "Show the prompt sent to the model",
    hidePrompt: "hide",
    ...
    resultAppears: "The result will appear as soon as it arrives.",
    resultAppearsLimit: " The limit is {n} seconds.",
