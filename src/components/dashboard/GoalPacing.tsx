...
const T = {
  ...
  en: {
    ...
    chanceLabel: "· {pct} chance of hitting goal",
    chanceSettling: "· forecast settles after a few days",
    finalRevenue: "Final revenue",
    forecast: "Month-end forecast",
    goalSuffix: "· goal {amount}",
    overGoal: "{pct} above goal",
    belowGoal: "{pct} below goal",
    gaugeNote: "Solid = revenue to date{forecastPart}; vertical marker = goal{planPart}{ciPart}.",
    ...
    historyHit: "goal met",
    historyMiss: "goal missed",
    planTitle: "Today's plan {amount}",
    goalTitle: "Goal {amount}",
  ...
  return (
    <div className="card animate-fade-up p-5 sm:p-6">
      ...
      <div className="mt-4 grid gap-x-8 gap-y-5 lg:grid-cols-[minmax(0,1fr)_260px]">
        ...
        {showRequired && impliedExtraDailySpend >= 1 && (
          <p className="mt-2 text-xs text-muted">
            {t(pacing.impliedBasis === "curve" ? "impliedBasisCurve" : "impliedBasisAverage")}
          </p>
        )}
      </div>
    </div>
