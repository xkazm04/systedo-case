...
const T = {
  cs: {
    badge: "Ukázková data",
    defaultNote:
      "Čísla jsou ilustrativní (vygenerovaná pro každý projekt zvlášť) — nejde o vaše reálná data z reklamních účtů. Skutečná data se napojí přes konektor (viz poznámky „Seam“).",
  },
  en: {
    badge: "Sample data",
    defaultNote:
