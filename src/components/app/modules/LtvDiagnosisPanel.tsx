...
const T = {
  cs: {
    ...
    idleHint: "Vyberte „Spustit rozbor“ a model přečte jednotkovou ekonomiku kohort výše. Doporučí, kde začít. Funguje i bez API klíče v ukázkovém režimu.",
  ...
  en: {
    ...
    idleHint: "Select “Run analysis” and the model will read the unit economics above. It will recommend where to start. Works without an API key in demo mode.",
