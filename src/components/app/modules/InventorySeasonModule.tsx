...
const T = {
  cs: {
    ...
    colMargin: "Marže",
    colStockoutAt: "Vyprodáno do",
    colResumeAt: "Naplánované naskladnění",
    colStatus: "Stav",
  ...
  en: {
    ...
    budgetShiftTitle: "Propose budget move",
    shiftTotal: "Move {amount}",
    noShift: "No move needed. All SKUs can run at full budget.",
