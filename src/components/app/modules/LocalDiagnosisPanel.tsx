...
const T = {
  cs: {
    ...
    idleHint: "Vyberte „Spustit diagnózu“ a model přečte pokrytí, pozice a recenze výše. Doporučí, kde začít. Funguje i bez API klíče v ukázkovém režimu.",
  ...
  en: {
    ...
    idleHint: "Select “Run diagnosis” and the model will read the coverage, positions and reviews above. It will recommend where to start. Works without an API key in demo mode.",
