...
const T = {
  cs: {
    ...
    colLocation: "Pobočka",
    colServices: "Služby",
    colGbp: "Google Business Profile",
    ...
    focusGbp: "Stav Google Business Profile",
    ...
    gatingNote: "Ovládací prvky (autopilot, rozpočet, publikování) se aktivují po připojení Google Business Profile a živých zdrojů. Zobrazená data jsou ilustrativní.",
    gatingNoteLive: "Stav Google Business Profile, recenze a nezodpovězené jsou z importu. Ovládací prvky (autopilot, rozpočet, publikování) se aktivují po napojení živých akčních zdrojů.",
  ...
  en: {
    ...
    focusGbp: "Google Business Profile status",
    ...
    gatingNote: "Controls (autopilot, budget, publishing) activate once a Google Business Profile and live sources are connected. The figures shown are illustrative.",
    gatingNoteLive: "Google Business Profile status, reviews and unanswered counts are imported. Controls (autopilot, budget, publishing) activate once live action sources are connected.",
