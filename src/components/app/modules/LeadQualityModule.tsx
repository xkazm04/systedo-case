...
import { Bulb, Bell } from "@/components/icons";
...
import FunnelBySourceCard from "@/components/app/modules/leads/FunnelBySourceCard";
...
const T = {
  cs: {
    ...
    junkAlertPre: "Některé zdroje mají nízké CPL, ale po kvalifikaci jsou drahé (vysoké CPQL). Zaměřte úsilí i rozpočet na",
    ...
    nextStepLabel: "Zaměřit se na kvalitní zdroje",
  ...
  en: {
    ...
    junkAlertPre: "Some sources have low CPL but are expensive after qualification (high CPQL). Focus effort and budget on",
    ...
    nextStepLabel: "Focus on quality sources",
...
export default async function LeadQualityModule({
  ...
  return (
    <div className="stagger space-y-6">
      ...
      {/* Lead → close funnel by source (extracted — W3-C seams LOC trim). */}
      <FunnelBySourceCard funnels={funnels} velocityTotal={velocity.total} />
