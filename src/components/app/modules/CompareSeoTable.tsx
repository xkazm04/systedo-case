...
const T = {
  cs: {
    ...
    colAcquisitionTitle: "Odhadované konverze/měs, pokud se na dotaz umístíte: z reálné konverzní míry organického kanálu × hledanost × záměr",
    colAction: "Akce",
    oppHigh: "Vysoká",
    oppMedium: "Střední",
    oppLow: "Nízká",
    acqTitle: "Odhad při umístění v top 3 dle kanálu {ch}: hledanost × CTR (~25 %) × CR {cr} × záměr{rev}",
  ...
  en: {
    ...
    channelEst: "estimate via the {ch} channel (CR {cr})",
    ...
    intentWeightAria: "Intent weight for {label}",
    ...
    listNoCompare: "“{name}” has no comparison queries. Showing the sample.",
    ...
    oppMedium: "Medium",
    oppLow: "Low",
    acqTitle: "Estimate at a top-3 placement via the {ch} channel: volume × CTR (~25%) × CR {cr} × intent{rev}",
    acqRevSuffix: " ≈ {rev}/mo",
    ...
    generatingRow: "Generating a comparison page scaffold for “{q}”…",
