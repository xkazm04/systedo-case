...
const T = {
  cs: {
    ...
    idleHint: "Vyberte experiment a vyberte „Navrhnout varianty“. Model z klastru navrhne nové challengery k otestování proti kontrole. Funguje i bez API klíče v ukázkovém režimu.",
  ...
  en: {
    ...
    idleHint: "Select an experiment and select “Suggest variants”. The model will propose new challengers from the cluster to test against the control. Works without an API key in demo mode.",
