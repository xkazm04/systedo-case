...
const T = {
  cs: {
    ...
    idleHint: "Vyberte podvýkonný zdroj a vyberte „AI diagnóza“. Model přečte jeho čísla a určí, proč je podvýkonný a kde začít. Funguje i bez API klíče v ukázkovém režimu.",
  ...
  en: {
    ...
    idleHint: "Select an under-performing source and select “AI diagnosis”. The model will read its numbers and determine why it under-performs and where to start. Works without an API key in demo mode.",
