...
const T = {
  cs: {
    ...
    body: "Naplňte aplikaci vaší firmou, vyberte kanály zdarma a připojte data. {done} z {total} kroků hotovo.",
  ...
  en: {
    ...
    body: "Seed the app with your business, pick your free channels and connect your data. {done} of {total} steps done.",
    next: "Next: {label}",
    continue: "Continue",
    dismiss: "Hide",
  },
