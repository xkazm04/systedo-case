# Systedo case study — historie projektu

> Adamant vznikl jako případová studie pro pozici „AI Vibecoder“ (Systedo). Tento
> dokument uchovává původní README té studie beze změn — jako historii projektu.
> Produktové README žije v kořenovém [`README.md`](../README.md).
